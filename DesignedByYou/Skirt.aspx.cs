...
{
    public partial class Skirt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string imgPath = "~/Images/Skirt/" + Request.QueryString["Name"].ToString();
                imgJacket.Src = imgPath;
                imgJacket.Height = 300;
                imgJacket.Width = 150;
                //   string path = "~/Images/Jacket/";
                DirectoryInfo d = new DirectoryInfo(@"C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Skirt");
