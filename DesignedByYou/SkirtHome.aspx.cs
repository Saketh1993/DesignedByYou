...
{
    public partial class SkirtHome : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            string path = "Images/Dress/Design/";
            DirectoryInfo d = new DirectoryInfo(@"C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Skirt/Design");
        ...
        public void img_Click(object sender, ImageClickEventArgs e)
        {
            ...
            "alert('" + id + "');", true);
            Response.Redirect("~/Skirt.aspx?Name=" + id + "");
        }
    }
}