...
namespace DesignedByYou
{
    ...
    public partial class DressHome : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                DirectoryInfo d = new DirectoryInfo(@"C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Dress/Design");
        ...
        public void img_Click(object sender, ImageClickEventArgs e)
        {
           ...
           // ScriptManager.RegisterStartupScript(Page, this.GetType(), "alert", string.Format("alert('{1}', '{0}');","COnfirm" , Title), true);
            ...
            "alert('"+id+"');", true);
            Response.Redirect("~/Dress.aspx?Name="+id+"");
        }
    }
}