...
namespace DesignedByYou.clothing
{
    public partial class Jackets : System.Web.UI.Page
    {
        ...
        {
            string Jacket = Request.QueryString["Name"].ToString().Trim().Split('.').First().Split('_').First().ToString();
            if (!Page.IsPostBack)
            {
                string imgPath = "~/Images/Jacket/" + Request.QueryString["Name"].ToString();
                imgJacket.Src = imgPath;
                //   string path = "~/Images/Jacket/";
                DirectoryInfo d = new DirectoryInfo(@"C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Jacket");
            ...
            {
                //string[] szColors = { "Red", "Black", "Blue" };
                string name = color.Split('.').First();
                if (name.Contains(Jacket + "_"))
                {
            ...
            lblPrice.Text = "$98";
           // Description.InnerHtml = " Product Details \n Off-white and navy striped knitted boxy top, has a round neck, short extended sleeves Material & Care <hr />Material & Care \n Viscose rayon\n Machine-wash";
        }
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            string path = "~/Images/Jacket/";
            DirectoryInfo d = new DirectoryInfo(@"C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Jacket");
            // string directory = "C:/Users/saki/Documents/Visual Studio 2013/Projects/DesignedByYou/DesignedByYou/Images/Jacket/Dress_" + btn.Text.Trim();
            FileInfo[] Files = d.GetFiles("*.*"); //Getting Text files
